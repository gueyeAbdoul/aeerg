                ...
                @auth
                    <div class="flex flex-col items-center">
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="mt-1">
                            ...
                            <button
                                type="submit"
                                class="mt-1 text-sm font-medium group-hover:text-yellow-300"
                            >
                                Se déconnecter
                            </button>
                        </form>
                ...
                @else
                    <a href="{{ route('login') }}" class="flex flex-col items-center group">
                        <img
                            ...
                            alt="Profil"
                            class="w-10 h-10 rounded-full object-cover group-hover:ring-2 group-hover:ring-yellow-300 transition"
                        >
                        <span class="mt-1 text-sm font-medium group-hover:text-yellow-300">
                            Se connecter
                        </span>
                    </a>
                @endauth
